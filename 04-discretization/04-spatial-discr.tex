...
To get the \emph{weak form}: rewrite a differential equation such that the equation does not contain any derivatives of the solution. You can then find solutions that are actually not differentiable. Derivatives in the original equation may not all exist, but nevertheless satisfy the equation in some specifically defined way.\\ %Wikipedia.
--------------------------

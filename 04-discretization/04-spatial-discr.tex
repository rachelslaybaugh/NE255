...
What we have done is a finite element method \textit{within} one spatial cell. This strategy results in \textbf{four} unknowns per cell. This is not quite the same as how we typically think of finite element methods. 

...
Boundary conditions:
\begin{enumerate}
\item Initial Value Problem (\textbf{IVP}): if y and its derivatives are given at one end of the domain (e.g.\ time zero if there's time or spatial starting point if there's only space, etc.)
